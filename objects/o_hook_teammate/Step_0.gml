if father != noone {
	magnetism = father.magnetism;
	magnet_force = father.magnet_force;

	spd_down = father.spd_hook_down;
	spd_up = father.spd_hook_up;
	max_catch = father.max_catch;
}
...
if subindo {
	...
	if y <= initial_y {
		...
		father.state = father.state_search;
		father.target = noone;
		instance_destroy(self); 
	}	
}
